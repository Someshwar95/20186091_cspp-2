...
class Fitnessgoals {
    ...
    public void showFoodlog() {
        ...
        for (Foodlog fodlog : foodlog) {
            System.out.println(fodlog);
        }
    }
    ...
    public void showWaterlog() {
        ...
        for (Waterlog watrlog : waterlog) {
            System.out.println(watrlog);
        }
    }
    ...
    public void showPhysicalActivity() {
        ...
        for (PhysicalActivity phyactlog : physicalactivitylog) {
            System.out.println(phyactlog);
        }
    }
    ...
    public void showWeightlog() {
        ...
        for (Weightlog wghtlog : weightlog) {
            System.out.println(wghtlog);
        }
    }
